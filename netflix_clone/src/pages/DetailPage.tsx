                    ...
                    <div className="absolute inset-0 bg-gradient-to-t from-[#181818] to-transparent" />
                        ...
                        <div className="flex gap-4 mb-2 justify-between">
                            <div className="flex gap-2">
                                ...
                                <button className="bg-black/5 text-white w-[38px] h-[38px] rounded-full flex items-center justify-center border-2 border-solid border-gray-400 hover:bg-gray-500 " aria-label="찜하기">
                                    <Icons.PlusMedium className="w-[17px] h-[17px]" />
                                </button>
                                <button className="bg-black/5 text-white w-[38px] h-[38px] rounded-full flex items-center justify-center border-2 border-solid border-gray-400 hover:bg-gray-500 " aria-label="좋아요">
                                    <Icons.ThumbsUpMedium className="w-[17px] h-[17px]" />
                                </button>
                            </div>
                            <button className="bg-black/5 text-gray-500 w-[35px] h-[35px] rounded-full flex items-center justify-center border-2 border-solid border-white/20  hover:bg-gray-500" >
                                <Icons.VolumeOffMedium className="w-[17px] h-[17px]" />
                            </button>
                        </div>
                    </div>
                </div>
                    ...
                    <div className="mt-8">
                        ...
                        {moviesData.movies.length > 9 && (
                            <div className="relative mt-[-50px] flex items-center justify-center">
                                <div className="absolute inset-x-0 mt-[-60px] h-16 bg-gradient-to-b from-transparent via-black/40 to-black/80" />
                                <div className="absolute inset-x-0 top-1/2 h-0.5 bg-white/30" />
                                <div className="absolute inset-x-0 top-1/2 h-10 bg-gradient-to-b from-black/60 to-black pointer-events-none" />
                                <button
                                    onClick={() => setShowAll(!showAll)}
                                    className="z-10 flex h-[38px] w-[38px] items-center justify-center rounded-full border-2 border-gray-400 bg-black/30 text-white hover:border-gray-300"
                                >
                                    {showAll ? (
